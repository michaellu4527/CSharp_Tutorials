    ...
    public partial class Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (heroHealth > 0 && monsterHealth > 0)
            {
                ...
                // CANNOT skip optional parameters unless it is the very last one
                //monsterHealth = performAttack(monsterHealth, 20, "Monster", "Hero",,10);
        ...
        private int performAttack(int defenderHealth,
            ...
            string attackerName,
            string defenderName,
            double criticalHitChance = 0.1, // Must include a value for it to be considered an "optional" paramater  
