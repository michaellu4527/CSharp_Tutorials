    ...
    public class GameActions
    {
        ...
        public static void Battle(Character attacker, Character defender)
        {
            if (attacker.HitPoints <= 0)
                throw new ArgumentOutOfRangeException("Attacker is dead and thus, cannot attack...");
            if (defender.HitPoints <= 0)
                throw new ArgumentOutOfRangeException("Defender is dead and thus, cannot attack...");
